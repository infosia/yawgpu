...
#[cfg(feature = "metal")]
fn metal_request_adapter_reports_non_empty_name() {
    ...
    unsafe {
        ...
        assert_eq!(info.backendType, native::WGPUBackendType_Metal);
...
#[ignore = "manual real-backend test"]
#[cfg(feature = "metal")]
fn metal_request_device_get_queue_and_empty_submit() {
    if real_backend_skip_reason(RealBackend::Metal).is_some() {
        return;
    }
