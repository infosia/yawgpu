//! CTS port of `webgpu/api/validation/capability_checks/limits/minUniformBufferOffsetAlignment.spec.ts`.

use crate::common;

#[test]
fn create_bind_group_at_over() {
    unsafe { common::assert_min_uniform_buffer_offset_alignment_at_over() };
}
