//! CTS port of `webgpu/api/validation/capability_checks/limits/maxComputeWorkgroupSizeX.spec.ts`.

use crate::common;

#[test]
fn create_compute_pipeline_at_over() {
    unsafe { common::assert_max_compute_workgroup_size_x_create_compute_pipeline_at_over() };
}
