...
/// accepted AND each layer written independently. Reads back per-layer values.
#[test]
#[ignore = "manual real-backend test"]
fn vulkan_storage_2d_array_binding_writes_per_layer() {
...
#[test]
#[ignore = "manual real-backend test"]
fn vulkan_same_3d_texture_disjoint_copy() {
...
/// implemented". A byte round-trip needs no decoder.
#[test]
#[ignore = "manual real-backend test"]
fn vulkan_bc1_compressed_roundtrip() {
...
/// without it, layer 1 reads from the wrong buffer offset).
#[test]
#[ignore = "manual real-backend test"]
fn vulkan_compressed_multilayer_roundtrip() {
