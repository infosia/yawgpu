...
mod tests {
    ...
    #[test]
    fn maps_float32_blendable_feature_round_trip() {
        assert_eq!(
            map_feature(native::WGPUFeatureName_Float32Blendable),
            core::Feature::Float32Blendable
        );
        assert_eq!(
            map_feature_to_native(core::Feature::Float32Blendable),
            native::WGPUFeatureName_Float32Blendable
        );
    }

    #[test]
    fn maps_dual_source_blending_feature_round_trip() {
        assert_eq!(
            map_feature(native::WGPUFeatureName_DualSourceBlending),
            core::Feature::DualSourceBlending
        );
        assert_eq!(
    ...
    #[test]
    fn maps_clip_distances_feature_round_trip() {
        assert_eq!(
            map_feature(native::WGPUFeatureName_ClipDistances),
            core::Feature::ClipDistances
        );
        assert_eq!(
